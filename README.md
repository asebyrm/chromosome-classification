...
Below is an example output generated by the model, showing polygon annotation and predicted chromosome class label.

![Annotated Sample](outputs/annotations/C6-0151_37_annotated.jpg)
